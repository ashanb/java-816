...
// Compile time: javac -p C:\bins\javafx-jmods -d out --module-source-path src -m easytext.cli,easytext.gui,easytext.analysis

// Runtime: java -p C:\bins\javafx-sdk-11.0.2\lib\;out -m easytext.gui/javamodularity.easytext.gui.Main
