...
public class Main {
 // compile: javac -d out/easytext src/easytext/javamodularity/easytext/Main.java src/easytext/module-info.java
 // create mod directory.
 // package: jar -cfe mods/easytext.jar javamodularity.easytext.Main -C out/easytext .
